...
<link href="resources/bootstrap-3.3.6/css/simple-sidebar.css"
	rel="stylesheet">
<link href="<c:url value="/resources/css/sudoku.css" />"
	rel="stylesheet">
...
<body>
	<div id="wrapper">
		...
		<c:if test="${not empty mainVue.mainSud}">

			<ul>
				<c:forEach var="listValue" items="${mainVue.mainNord}">
					<li>${listValue}</li>
				</c:forEach>
			</ul>
	...
	<!-- Script maison-->
	<script src="<c:url value="/resources/js/jouerbridge.js"/>"></script>
